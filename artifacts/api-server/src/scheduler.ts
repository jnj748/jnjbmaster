...
import { db, tenantsTable, ownersTable, dataDestructionLogsTable, notificationsTable, vehiclesTable, dailyReportsTable, weeklySummaryReportsTable, monthlySummaryReportsTable, inspectionsTable, inspectionLogsTable, unitsTable, delinquencyActionsTable } from "@workspace/db";
