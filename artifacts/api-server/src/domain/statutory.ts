...
// 4. 기계설비유지관리자 (기계설비법 제18조, 시행규칙 별표1)
// [Task #106] 2026-04-18 법령 원문 정합성 정정.
//   - 특급(책임): 6만㎡ 이상 (또는 3천세대 이상 공동주택)
//   - 고급(책임): 3만~6만㎡
//   - 중급(책임): 1.5만~3만㎡
//   - 초급(책임): 1만~1.5만㎡
// 기존 코드는 특급 30000 / 고급 20000으로 잘못 설정되어 있었음.
// calculate-safety 판정은 더 엄격한 등급에서 더 완화된 등급으로만 이동(예: 5만㎡ "특급"→"고급").
// 안전성 측면 위배 없음.
export const MECH_REQUIRED_AREA = 10000;
export const MECH_SPECIAL_GRADE_AREA = 60000;
export const MECH_ADVANCED_GRADE_AREA = 30000;
