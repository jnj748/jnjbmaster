...
router.post("/document-templates", requireRole("executive", "manager"), async (req, res): Promise<void> => {
...
router.put("/document-templates/:id", requireRole("executive", "manager"), async (req, res): Promise<void> => {
  const id = Number(req.params.id);
  const { name, category, description, fields, bodyTemplate, sortOrder } = req.body;
...
router.delete("/document-templates/:id", requireRole("executive", "manager"), async (req, res): Promise<void> => {
  const id = Number(req.params.id);
