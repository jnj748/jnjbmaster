...
const EXPECTED_SIDEBAR: Record<Role, Snapshot> = {
  ...
  accountant: [
    { title: "오늘의 한눈 대시보드", paths: ["/", "/calendar", "/work-log"] },
    {
      title: "단지·설정",
      paths: [
        "/units",
    ...
    },
    {
      ...
      paths: [
        "/tenants",
        "/vehicles",
        "/residents/key-issuance",
        "/residents/move-in-out",
        "/residents/privacy-access-log",
        "/long-term-repair-allocation",
      ],
    },
    {
      title: "검침",
    ...
    },
    {
      ...
      paths: [
        "/accounting/journals",
        "/accounting/journal-search",
        "/accounting/opening-balances",
        "/accounting/fiscal-periods",
        "/accounting/report-formats",
        "/accounting/data-export",
        "/accounting/ledger/journal",
        "/accounting/ledger/daily",
        "/accounting/ledger/monthly",
        "/accounting/ledger/cash",
        "/accounting/ledger/bank-deposits",
        "/accounting/ledger/general",
        "/accounting/ledger/sub",
        "/accounting/ledger/account-balance",
        "/accounting/ledger/management-expenses",
