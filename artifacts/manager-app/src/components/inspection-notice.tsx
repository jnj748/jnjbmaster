...
export const CATEGORY_LEGAL_BASIS: Record<string, string> = {
  ...
  electrical: "전기사업법 제63조, 전기안전관리법 제22조",
  gas: "도시가스사업법 제17조 (정기검사)",
  septic: "하수도법 제39조 (개인하수처리시설 관리)",
  playground: "어린이놀이시설 안전관리법 제12조, 제15조",
  safety_check: "재난 및 안전관리 기본법 제66조의7",
  hygiene: "수도법 제33조, 실내공기질 관리법 제12조",
  building_safety: "시설물의 안전 및 유지관리에 관한 특별법 제11조",
  administrative: "관리규약, 개인정보보호법",
  other: "",
};
...
export const CATEGORY_NOTICE_TEMPLATE: Record<string, string> = {
  ...
  playground:
    "안녕하세요, 입주민 여러분.\n\n어린이놀이시설 안전관리법에 따라 아래와 같이 놀이터 안전점검을 실시합니다.\n점검 시간 동안 놀이터 이용이 제한될 수 있으니 양해 부탁드립니다.\n어린이의 안전을 위한 법정 점검이오니 주민 여러분의 협조를 부탁드립니다.",
  safety_check:
    "안녕하세요, 입주민 여러분.\n\n재난 및 안전관리 기본법에 따라 아래와 같이 시설물 안전점검을 실시합니다.\n점검 시간 동안 불편을 드릴 수 있으니 양해 부탁드립니다.\n안전한 주거환경을 위한 점검이오니 주민 여러분의 협조를 부탁드립니다.",
  hygiene:
    "안녕하세요, 입주민 여러분.\n\n관련 법령에 따라 아래와 같이 위생/환경 검사를 실시합니다.\n쾌적한 주거환경을 위한 법정 점검이오니 주민 여러분의 협조를 부탁드립니다.",
  building_safety:
    "안녕하세요, 입주민 여러분.\n\n시설물안전관리법에 따라 아래와 같이 건축물 정기점검을 실시합니다.\n점검 시간 동안 일부 공용시설 이용이 제한될 수 있으니 양해 부탁드립니다.\n안전한 건축물 유지를 위한 법정 점검이오니 주민 여러분의 협조를 부탁드립니다.",
  administrative:
    "안녕하세요, 입주민 여러분.\n\n아래와 같이 행정 업무를 안내드립니다.\n원활한 관리를 위해 주민 여러분의 협조를 부탁드립니다.",
  other:
    "안녕하세요, 입주민 여러분.\n\n아래와 같이 시설 점검을 실시합니다.\n점검 시간 동안 불편을 드릴 수 있으니 양해 부탁드립니다.\n안전한 주거환경을 위한 점검이오니 주민 여러분의 협조를 부탁드립니다.",
};
